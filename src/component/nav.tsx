...
export function Nav(props: NavProps) {
  ...
  return (
    <header className="flex justify-between gap-x-52 h-20 items-center">
      <ul className="flex justify-between list-none text-sm flex-1 font-semibold tracking-normal">
        <li>{name}</li>
        <li>Currently work at {workAt}</li>
        <li>Based in {location}</li>
      </ul>
      <nav className="h-full flex justify-between items-center">
        <ul className="flex justify-between list-none text-sm	flex-1 font-semibold w-40 ">
